...
{
    const auto compare_border_and_coordinate = [](const s64 n, const f64 s, const f64 x, const auto cmp)
    {
        std::array<f64, 3> fms;
    ...
    if (a_x < b_x)
    {
        compare_border_and_coordinate(c_x, size, a_x, std::greater_equal<f64> {});
        compare_border_and_coordinate(c_x, size, b_x, std::less_equal<f64> {});
    }
    else
    {
        compare_border_and_coordinate(c_x, size, a_x, std::less_equal<f64> {});
        compare_border_and_coordinate(c_x, size, b_x, std::greater_equal<f64> {});
    }
